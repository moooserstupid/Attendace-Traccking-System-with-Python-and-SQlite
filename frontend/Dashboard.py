...
class Ui_DashboardWindow(object):
    def setupUi(self, DashboardWindow):
        ...
        self.label_8 = QtWidgets.QLabel(self.add_course_page)
        ...
        self.teacher_name_comboBox = QtWidgets.QComboBox(self.add_course_page)
        self.teacher_name_comboBox.setObjectName("teacher_name_comboBox")
        ...
        item_0 = QtWidgets.QTreeWidgetItem(self.lessons_treeWidget)
        item_0 = QtWidgets.QTreeWidgetItem(self.lessons_treeWidget)
        item_0 = QtWidgets.QTreeWidgetItem(self.lessons_treeWidget)
        ...
        self.ta_username_lineEdit = QtWidgets.QLineEdit(self.teacher_info_page)
        self.ta_username_lineEdit.setEnabled(True)
        self.ta_username_lineEdit.setMaximumSize(QtCore.QSize(250, 16777215))
        self.ta_username_lineEdit.setObjectName("ta_username_lineEdit")
        ...
        self.pushButton_30 = QtWidgets.QPushButton(self.teacher_info_page)
    ...
    def retranslateUi(self, DashboardWindow):
        ...
        self.label_8.setText(_translate("DashboardWindow", "Teacher Name:"))
        ...
        self.lessons_treeWidget.topLevelItem(0).setText(0, _translate("DashboardWindow", "26/12/2022"))
        self.lessons_treeWidget.topLevelItem(0).setText(2, _translate("DashboardWindow", "VTYS"))
        self.lessons_treeWidget.topLevelItem(1).setText(0, _translate("DashboardWindow", "19/12/2022"))
        self.lessons_treeWidget.topLevelItem(1).setText(2, _translate("DashboardWindow", "VTYS"))
        self.lessons_treeWidget.topLevelItem(2).setText(0, _translate("DashboardWindow", "12/12/2022"))
        self.lessons_treeWidget.topLevelItem(2).setText(2, _translate("DashboardWindow", "VTYS"))
        ...
        self.students_treeWidget.headerItem().setText(0, _translate("DashboardWindow", "Name"))
        self.students_treeWidget.headerItem().setText(1, _translate("DashboardWindow", "Surname"))
        self.students_treeWidget.headerItem().setText(2, _translate("DashboardWindow", "ID"))
        self.students_treeWidget.headerItem().setText(3, _translate("DashboardWindow", "Student No"))
        ...
        self.attendance_treeWidget.headerItem().setText(2, _translate("DashboardWindow", "Lesson Name"))
        ...
        self.pushButton_30.setText(_translate("DashboardWindow", "Update"))
